...
> Version 4.16.0 raises the minimum go version to v1.25, patches will likely be backported to v4.15.x but new features will only be available in versions > v4.16.0.
